    ...
    print('''                    .-._   _ _ _ _ _ _ _ _
         ...
         '.___ '    .   .--_'-' '-' '-' _'-' '._
          ...
          snd                         (((-'\ .' /
                                   ...
                                   '-._____.-'
''')
    print("You are attacked by crocodiles. Better luck next time")
  else :
    print('''
            __________       
           |  __  __  |
...
''')
 ...
 `-'.'`-'dd
 ''')
      print("You have entered into a room of fire and burnt yourself. Game over")
    elif door == "blue" :
      print('''
                   (    )
                  ((((()))
        ...
        \(  \\.-' ( /    \/    \)
         '  ()) _'.-|/\/\/\/\/\|
          ...
          _____ //,/" ___ ((( ', ___
                        ...
                        /,/,"
''')
      print("You have entered into a room full of beasts and been eaten by them. Game over")
    elif door == "yellow" :
      print("Hurray! You have won the treasure. Don't forget to pay the taxes lol")
    else:
